...
val slimModel = listOf(
    // === Base layers ===
    // Head: UV (0, 0)
    Box3D(-4f, 24f, -4f, 8f, 8f, 8f, uvX = 0, uvY = 0),
    // Body: UV (16, 16)
    Box3D(-4f, 12f, -2f, 8f, 12f, 4f, uvX = 16, uvY = 16),
    // Right Arm (slim): UV (40, 16)
    Box3D(-7f, 12f, -2f, 3f, 12f, 4f, uvX = 40, uvY = 16),
    // Left Arm (slim): UV (32, 48)
    Box3D(4f, 12f, -2f, 3f, 12f, 4f, uvX = 32, uvY = 48),
    // Right Leg: UV (0, 16)
    ...
    // Right Arm Layer 2 (slim): UV (40, 32), size 3x12x4
    Box3D(
        -7f - OVERLAY_SCALE,
        12f - OVERLAY_SCALE,
        -2f - OVERLAY_SCALE,
    ...
    // Left Arm Layer 2 (slim): UV (48, 48), size 3x12x4
    Box3D(
        4f - OVERLAY_SCALE,
        12f - OVERLAY_SCALE,
        -2f - OVERLAY_SCALE,
