...
data class ClientProfileResponse(
    ...
    @SerialName("arguments") val arguments: Arguments?,
    @SerialName("assetIndex") val assetIndex: AssetIndex?,
    @SerialName("assets") val assets: String?,
    @SerialName("complianceLevel") val complianceLevel: String?,
    @SerialName("downloads") val downloads: Downloads?,
    @SerialName("javaVersion") val javaVersion: JavaVersion?,
    @SerialName("libraries") val libraries: List<LibraryDownloads>?,
    @SerialName("extra") val extra: List<DownloadArtifact>?,
    ...
    @SerialName("modules") val modules: List<Module>?
) {
    ...
    data class Arguments(
        @SerialName("game") val game: List<JsonElement>?,
        @SerialName("jvm") val jvm: List<JsonElement>?
    )
    ...
    data class Rule(
        ...
        @SerialName("features") val features: Map<String, String>?,
        @SerialName("os") val os: Map<String, String>?
    )
    ...
    data class Downloads(
        @SerialName("client") val client: DownloadArtifact?,
        @SerialName("client_mappings") val clientMappings: DownloadArtifact?,
        @SerialName("server") val server: DownloadArtifact?,
        @SerialName("server_mappings") val serverMappings: DownloadArtifact?
    )

    @Serializable
    data class LibraryDownloads(
        @SerialName("downloads") val downloads: LibraryDownloadItem?
    )

    @Serializable
    data class LibraryDownloadItem(
        @SerialName("artifact") val artifact: DownloadArtifact?,
        @SerialName("classifiers") val classifiers: Classifiers?,
        @SerialName("name") val name: String?,
    )

    @Serializable
    data class Classifiers(
        @SerialName("natives-windows") val nativesWindows: DownloadArtifact?,
        @SerialName("natives-linux") val nativesLinux: DownloadArtifact?,
        @SerialName("natives-macos") val nativesMacos: DownloadArtifact?,
    )
...
//      "size": 5746047,
//      "url": "https://piston-data.mojang.com/v1/objects/374c6b789574afbdc901371207155661e0509e17/client.txt"
//    },
//    "server": {
...
//      "size": 4400926,
//      "url": "https://piston-data.mojang.com/v1/objects/41285beda6d251d190f2bf33beadd4fee187df7a/server.txt"
//    }
//  },
//  "id": "1.16.5",
//  "javaVersion": {
